...
insert_story = "INSERT INTO stories(users_edited, title, full_text, edit) VALUES( \"admin\", \"hello\", \"The farmer went to the barn and said hello to his animals\", \"The farmer went to the barn and said hello to his animals.\");"
create_table_stories = "CREATE TABLE stories(story_id INTEGER PRIMARY KEY AUTOINCREMENT, users_edited TEXT, title TEXT, full_text TEXT, edit TEXT);"
