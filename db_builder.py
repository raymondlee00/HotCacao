...
insert_one = "INSERT INTO users(user_id, username, password, stories_edited) VALUES( 1, \"admin\", \"peterstuy\", \"1\")"
create_table_users = "CREATE TABLE users(user_id INTEGER PRIMARY KEY AUTOINCREMENT, username TEXT, password TEXT, stories_edited TEXT DEFAULT \"\", timestamp DATETIME DEFAULT current_timestamp);"
